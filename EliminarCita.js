  ...
  render() {
    const eliminarCita = ()=>{
      var xhttp = new XMLHttpRequest();
        ...
        xhttp.open("GET", "https://entradascucei.000webhostapp.com/eliminarCita.php?id="+this.state.id, true);
      ...
      <View style={globalStyles.contenedorPrincipal}>
        ...
        <View style={globalStyles.centrar}>
          ...
          <View style={styles.textoContainer}>
            ...
            <Text style={styles.txtDatosBD}>{this.state.response.horaEntrada} </Text>
          </View>

          <View style={styles.textoContainer}>
            <Text style={styles.txtFila}>Destino: </Text>
            <Text style={styles.txtDatosBD}>{this.state.response.moduloDirigido} </Text>
          </View>
