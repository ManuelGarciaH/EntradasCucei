  ...
  render() {
    ...
    const CrearCita=()=>{
        ...
        if(nombreError || placasAutoError || marcaAutoError || diaError || horaEntradaError
            ...
            xhttp.open("GET", "https://entradascucei.000webhostapp.com/insertarCita.php?nombre="+this.state.nombre+"&marcaAuto="+this.state.marcaAuto+"&placasAuto="+this.state.placasAuto+"&horaEntrada="+this.state.horaEntrada+"&dia="+this.state.dia+"&puerta="+this.state.puerta+"&moduloDirigido="+this.state.moduloDirigido+"&id="+this.state.id, true);
      ...
      <View style={globalStyles.contenedorPrincipal}>
        ...
        <ScrollView style={styles.scrollContainer}>
            <View style={globalStyles.centrar}>
                ...
                <TextInput
                    defaultValue={this.props.route.params.nombre}
